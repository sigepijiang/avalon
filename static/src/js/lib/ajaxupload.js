Module('ajaxupload', function () {
    ...
    * */
    ...
    this.exports.upload = function (url, $inputFile, settings) {
        ...
        function upload() {
            ...
            if ($nextElement.length) {
                $nextElement.before($inputFile);
            } else {
                $inputFile.appendTo( $originalParent );
            }
        }
